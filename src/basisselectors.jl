...
levels provided in the dictionary `maxlevels::AbstractDict{Any, Float64}`. In the default
...
struct SparseBasis <: AbstractSparseBasis
    maxorder::Int
    weight::AbstractDict{Symbol,Float64}
    maxlevels::AbstractDict{Any,Float64}
    p::Float64
end
...
struct CategorySparseBasis <: AbstractSparseBasis
    ...
    p::Float64
    isym::Symbol
    minorder_dict::AbstractDict{Any,Int}
    maxorder_dict::AbstractDict{Any,Int}
    weight_cat::AbstractDict{Any,Float64}
end
...
function CategorySparseBasis(isym::Symbol, categories;
    ...
    minorder_dict=AbstractDict{Any,Float64}(),
    maxorder_dict=AbstractDict{Any,Float64}(),
